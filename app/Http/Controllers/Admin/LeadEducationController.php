...
class LeadEducationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $redirectUrl = '/admin/lead-profile/' . $leadId . '#education';
        ...
        return redirect('/admin/lead-profile/' . $validated['lead_id'] . '#education')->with('success', 'Education added successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/admin/lead-profile/' . $leadId . '#education')->with('success', 'Education deleted successfully.');
    }
}
