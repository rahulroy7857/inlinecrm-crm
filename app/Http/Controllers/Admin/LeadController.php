...
class LeadController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('admin.lead-profile', compact(
            'lead',
            'sources',
            'counselors',
            'academicYears',
    ...
    public function destroy($id)
    {
        ...
        return redirect('/admin/new-leads')->with('success', 'Lead deleted successfully.');
    }
    ...
    public function todayFollowups()
    {
        ...
        return view('admin.followups.today', compact('leads'));
    }
    ...
    public function tomorrowFollowups()
    {
        ...
        return view('admin.followups.tomorrow', compact('leads'));
    }
    ...
    public function search(Request $request)
    {
        if (!$request->has('column_name') || !$request->has('value')) {
            $leads = array();
            return view('admin.search', compact('leads'));
        }
        $leads = Lead::query()
            ->with(['source', 'course'])
    ...
    public function uploadLeads()
    {
        ...
        $counselors = Counselor::select('id', 'name')->where('status', 1)->get();
        return view('admin.upload-leads', compact('sources', 'counselors'));
    }
    ...
    public function upload(Request $request)
    {
        try {
            ...
            $import = new LeadsImport($request->source_id, $request->assign_to);
    ...
    public function transfer(Request $request)
    {
        ...
        LeadTransfer::create([
            ...
            'transferred_by' => auth()->guard('admin')->user()->name
        ]);
    ...
    public function statusWiseLeads($status)
    {
        ...
        return view('admin.status-wise-leads', compact(
            'leads',
            'status'
        ));
    }
