...
class LeadContactLogController extends Controller
{
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $redirectUrl = '/counselor/lead-profile/' . $leadId . '#call-log';
        ...
        return redirect('/counselor/lead-profile/' . $validated['lead_id'] . '#call-log')->with('success', 'Contact log added successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/counselor/lead-profile/' . $leadId . '#call-log')->with('success', 'Contact log deleted successfully.');
    }
}
