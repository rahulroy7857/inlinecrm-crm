...
class LeadExamController extends Controller
{
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $redirectUrl = '/counselor/lead-profile/' . $leadId . '#exams';
        ...
        return redirect('/counselor/lead-profile/' . $validated['lead_id'] . '#exams')->with('success', 'Exam added successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/counselor/lead-profile/' . $leadId . '#exams')->with('success', 'Exam deleted successfully.');
    }
}
