...
class CounselorBreak extends Model
{
    ...
    {
        return app(\App\Services\CounselorBreakSettingsService::class)->labelFor($this->type);
    }
    ...
    {
        return app(\App\Services\CounselorBreakSettingsService::class)->validTypes();
    }
}
