<nav class="layout-navbar" id="layout-navbar">
    <div class="flex w-full items-center gap-4">
        ...
        <form class="hidden flex-1 sm:flex sm:max-w-md" method="GET" action="{{ url('admin/search') }}">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item position-relative d-none d-sm-block">
                <a class="nav-link flex h-10 w-10 items-center justify-center rounded-lg hover:bg-slate-100" href="{{ url('admin/messages') }}">
            ...
            <li class="nav-item d-none d-sm-block">
                <a class="nav-link position-relative flex h-10 w-10 items-center justify-center rounded-lg hover:bg-slate-100" href="{{ url('admin/notifications') }}">
