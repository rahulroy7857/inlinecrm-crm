            ...
            <div class="card">
                ...
                <div class="card-body mt-3">
                    <div class="d-flex justify-content-center">
                        <form action="{{ route('admin.reports.leads') }}" method="GET" style="width: 99%; border: 1px solid #dee2e6; padding: 20px; border-radius: 5px;">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select class="select2-multiple form-select" id="counselor" name="counselor_id[]" multiple>
