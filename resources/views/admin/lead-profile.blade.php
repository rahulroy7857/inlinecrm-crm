                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="display: flex; align-items: center;">:<a href="#" 
                                                ...
                                                data-type="text" 
                                                data-pk="{{ $lead->id }}" 
                                                data-url="{{ route('admin.leads.update', $lead->id) }}" 
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="display: flex; align-items: center;">:
                                                    <a href="#"
                                                        ...
                                                        data-pk="{{ $lead->id }}"
                                                        data-url="{{ route('admin.leads.update', $lead->id) }}"
                                                        data-title="Select Admission Date"
                                                        data-value="{{ $lead->admission_date ? $lead->admission_date : '' }}"
                                                        data-placement="right"
                                                        data-combodate='{"minYear":2024,"maxYear":{{ date("Y") }}}'
                                                        style="display: inline-block; min-width: 50px; vertical-align: middle;"
                                                    >
                                            ...
                                            <tr>
                                                ...
                                                <td style="display: flex; align-items: center;">:<a href="#" 
                                                    ...
                                                    data-type="select" 
                                                    data-pk="{{ $lead->id }}" 
                                                    data-source="{{ json_encode($agents) }}"
                                                    data-value="{{ $lead->agent_id }}"
                                                    data-url="{{ route('admin.leads.update', $lead->id) }}" 
                                                    data-title="Edit Agent">{{ $lead->agent->name ?? 'Not Available' }}</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="display: flex; align-items: center;">:
                                                    <a href="#"
                                                       class="editable"
                                                       data-name="admission_no"
                                                       data-type="text"
                                                       data-pk="{{ $lead->id }}"
                                                       data-url="{{ route('admin.leads.update', $lead->id) }}"
                                                       data-title="Edit Admission No"
                                                       data-value="{{ $lead->admission_no ?? '' }}"
                                                       data-placement="right">
                                            ...
                                            <tr>
                                                <th style="width: 30%;">Agent Commission</th>
                                                <td style="display: flex; align-items: center;">:
                                                    <a href="#"
                                                        class="editable"
                                                        data-name="agent_commission"
                                                        data-type="number"
                                                        data-pk="{{ $lead->id }}"
                                                        data-url="{{ route('admin.leads.update', $lead->id) }}"
                                                        data-title="Edit Agent Commission"
                                                        data-value="{{ $lead->agent_commission ?? '' }}"
                                                        data-placement="right">
                                                         {{ $lead->agent_commission ?? 'Not Available' }}
                                                    </a>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#"
                                            ...
                                            data-url="{{ route('admin.lead.contact_logs.update', $contactLog->id) }}"
                                ...
                                <tr>
                                    <td>
                                        <a href="#" 
                                           ...
                                           data-url="{{ route('admin.lead.education.update', $education->id) }}" 
                                ...
                                <tr>
                                    <td>
                                        <a href="#"
                                           ...
                                           data-type="text"
                                           data-pk="{{ $exam->id }}"
                                           data-url="{{ route('admin.lead.exams.update', $exam->id) }}"
...
<div class="modal fade" id="transferModal" data-bs-backdrop="static" tabindex="-1">
  <div class="modal-dialog">
    <form class="modal-content" method="POST" action="{{ route('admin.lead.transfer') }}">
    @csrf
...
<div class="modal fade" id="educationModal" data-bs-backdrop="static" tabindex="-1">
  <div class="modal-dialog">
    <form class="modal-content" method="POST" action="{{ route('admin.lead.education.store') }}">
    @csrf
    <input type="hidden" name="lead_id" value="{{ $lead->id }}">
    <div class="modal-header border-bottom">
...
<div class="modal fade" id="examModal" data-bs-backdrop="static" tabindex="-1">
  <div class="modal-dialog">
    <form class="modal-content" method="POST" action="{{ route('admin.lead.exams.store') }}">
    @csrf
    <input type="hidden" name="lead_id" value="{{ $lead->id }}">
      <div class="modal-header border-bottom">
        <h5 class="modal-title" id="backDropModalTitle">Add Exam</h5>
...
<div class="modal fade" id="paymentModal" data-bs-backdrop="static" tabindex="-1">
  <div class="modal-dialog">
    <form class="modal-content" method="POST" action="{{ route('admin.lead.payments.store') }}">
      @csrf
      <input type="hidden" name="lead_id" value="{{ $lead->id }}">
      <div class="modal-header border-bottom">
...
<div class="modal fade" id="followupModal" data-bs-backdrop="static" tabindex="-1">
  <div class="modal-dialog">
    <form class="modal-content" method="POST" action="{{ route('admin.lead.contact_logs.store') }}">
      @csrf
        <input type="hidden" name="lead_id" value="{{ $lead->id }}">
      <div class="modal-header border-bottom">
...
<div class="modal fade" id="admissionModal" data-bs-backdrop="static" tabindex="-1">
  <div class="modal-dialog">
    <form class="modal-content" method="POST" action="{{ route('admin.lead.admission.store') }}">
      @csrf
      <input type="hidden" name="lead_id" value="{{ $lead->id }}">
      <div class="modal-header border-bottom">
...
<div class="modal fade" id="applicationModal" data-bs-backdrop="static" tabindex="-1">
  <div class="modal-dialog">
    <form class="modal-content" method="POST" action="{{ route('admin.lead.application.store') }}">
      @csrf
      <input type="hidden" name="lead_id" value="{{ $lead->id }}">
...
<div class="modal fade" id="reservationModal" data-bs-backdrop="static" tabindex="-1">
  <div class="modal-dialog">
    <form class="modal-content" method="POST" action="{{ route('admin.lead.reservation.store') }}">
      @csrf
      <input type="hidden" name="lead_id" value="{{ $lead->id }}">
...
<div class="modal fade" id="cancelModal" data-bs-backdrop="static" tabindex="-1">
  <div class="modal-dialog">
    <form class="modal-content" method="POST" action="{{ route('admin.lead.cancel') }}">
      @csrf
      <input type="hidden" name="lead_id" value="{{ $lead->id }}">
...
function updatePhoto(input) {
    if (input.files && input.files[0]) {
        ...
        $.ajax({
            url: '{{ route("admin.leads.update.photo", $lead->id) }}',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
