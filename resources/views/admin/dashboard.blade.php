...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y crm-page">
        ...
        <div class="row">
              ...
              <div class="card">
                ...
                <div class="row">
                                        ...
                                        <li class="d-flex mb-4 pb-1">
                                            ...
                                            <div
                                                ...
                                                <div class="me-2">
                                                    ...
                                                    <small class="text-muted">{{ $admission->college->name ?? 'N/A' }},
                                                        {{ $admission->course->name ?? 'N/A' }}</small>
                                                </div>
                                                <div class="user-progress">
                                                    <small
                                                        class="fw-semibold">{{ $admission->created_at->format('d/m/Y') }}</small>
                                                </div>
                                            </div>
                                        </li>
                                    @endforeach
                    ...
                    <div class="col-md-6 col-lg-4 order-1 mb-4">
                        <div class="chart-card h-100">
                            <div class="card-header">
                                <h5><i class="bx bx-pie-chart me-2"></i>Leads Status {{ session('academic_year_name') }}
                                </h5>
                            </div>
                            <div class="card-body">
                                    ...
                                    @foreach ($recentTransactions as $transaction)
                                        <li class="d-flex mb-4 pb-1">
                                            ...
                                            <div
                                                ...
                                                <div class="me-2">
                                                    <small
                                                        class="text-muted d-block mb-1">{{ $transaction->payment_mode }}</small>
            ...
            <div id="infoToast" class="bs-toast toast bg-info" role="alert" aria-live="assertive" aria-atomic="true"
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    if (monthlyLeadsChartElement) {
                        var options = {
                            series: [{
                                    name: "Total Leads",
                                    data: @json(array_values($monthlyLeadsData))
                                },
                        ...
                        var options = {
                            ...
                            dataLabels: {
                                ...
                                formatter: function(val, opts) {
                                    const stage = ['total', 'positive', 'application', 'admission'][opts
                                        .dataPointIndex
                                    ];
