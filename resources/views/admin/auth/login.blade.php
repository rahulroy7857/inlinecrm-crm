...
<head>
    ...
    <title>Admin Login — Inline CRM</title>
    <meta name="description" content="Sign in to Inline CRM admin panel." />
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-8 text-center">
                        ...
                        <p class="mt-1 text-sm text-slate-500">Sign in to your admin account</p>
                    </div>
