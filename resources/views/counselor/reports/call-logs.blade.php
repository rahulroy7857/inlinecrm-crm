            ...
            <div class="card">
                ...
                <div class="card-body mt-3">
                    <div class="d-flex justify-content-center">
                        <form action="{{ route('counselor.reports.call-logs') }}" method="GET" style="width: 99%; border: 1px solid #dee2e6; padding: 20px; border-radius: 5px;">
                            <div class="row">
                        ...
                        <table id="leadsTable" class="table table-bordered">
                            ...
                            <tbody class="table-border-bottom-0">
                                ...
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>
                                        <a href="{{ route('counselor.leads.show', $log->lead_id) }}" 
