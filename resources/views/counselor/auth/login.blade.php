...
<head>
    ...
    <title>Counselor Login — Inline CRM</title>
    <meta name="description" content="Sign in to Inline CRM counselor portal." />
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-8 text-center">
                        ...
                        <h1 class="text-2xl font-bold text-slate-900">Counselor Portal</h1>
