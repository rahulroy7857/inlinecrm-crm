...
<html>
  <head>
    ...
    <title>Login - Inline CRM</title>

    <meta name="description" content="Welcome to My Application. Please log in to continue." />
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- <h4 class="mb-2">Welcome to CRM! 👋</h4> -->
                ...
                <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('counselor.login') }}">
                @csrf
                <div class="mb-3">
