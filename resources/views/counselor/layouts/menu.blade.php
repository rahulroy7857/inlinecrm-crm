...
<style>
        ...
        <ul class="menu-inner py-1">
          <!-- Dashboard -->
            ...
            <a href="{{url('/counselor/leads-basket')}}" class="menu-link d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center">
              <i class="menu-icon tf-icons bx bx-user"></i>
              <div data-i18n="Leads Pool" class="">Leads Basket</div>
              </div>
              <span class="badge bg-info ms-2" id="basket-leads-count">0</span>
            </a>
            </li>
            <li class="menu-item {{ request()->is('counselor/new-leads') ? 'active' : '' }}">
            <a href="{{url('/counselor/new-leads')}}" class="menu-link d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center">
              <i class="menu-icon tf-icons bx bx-user"></i>
            ...
            <li class="menu-item {{ request()->is('counselor/followups/today') ? 'active' : '' }}">
              <a href="{{ url('/counselor/followups/today') }}" class="menu-link d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center">
            ...
            <li class="menu-item {{ request()->is('counselor/followups/tomorrow') ? 'active' : '' }}">
              <a href="{{ url('/counselor/followups/tomorrow') }}" class="menu-link d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center">
                <i class="menu-icon tf-icons bx bx-calendar"></i>
            ...
            <li class="menu-item {{ request()->is('counselor/followups/pending') ? 'active' : '' }}">
              <a href="{{ url('/counselor/followups/pending') }}" class="menu-link d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center">
                <i class="menu-icon tf-icons bx bx-calendar"></i>
            ...
            <li class="menu-item {{ request()->is('counselor/leads/bin') ? 'active' : '' }}">
              <a href="{{ url('/counselor/leads/bin') }}" class="menu-link d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center">
          ...
          <li class="menu-item {{ request()->is('counselor/reports*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
              <li class="menu-item {{ request()->is('counselor/reports/leads') ? 'active' : '' }}">
                <a href="{{ url('/counselor/reports/leads') }}" class="menu-link">
                  <div data-i18n="Leads">Leads</div>
                </a>
              </li>
                
                <li class="menu-item {{ request()->is('counselor/reports/call-logs') ? 'active' : '' }}">
                <a href="{{ url('/counselor/reports/call-logs') }}" class="menu-link">
                  <div data-i18n="Call Log">Call Log</div>
                </a>
                </li>
                
                <li class="menu-item {{ request()->is('counselor/reports/counselor-performance') ? 'active' : '' }}">
                  <a href="{{ url('/counselor/reports/counselor-performance') }}" class="menu-link">
                    <div data-i18n="Counselors Performance">Performance</div>
                  </a>
                </li>
            ...
            <form method="POST" action="{{ route('counselor.logout') }}" class="menu-link" style="display: flex; align-items: center;">
              @csrf
