<nav
        ...
        <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
          ...
          <form class="d-flex" method="GET" action="{{ url('counselor/search') }}">
            <input
              type="text"
              name="value"
          ...
          <!-- /Nova Style Search -->
            ...
            <a class="nav-link" href="{{ url('counselor/messages') }}">
            ...
            <li class="nav-item d-none d-sm-block" style="padding-right: 5px;">
            <a class="nav-link position-relative" href="{{ url('counselor/notifications') }}">
