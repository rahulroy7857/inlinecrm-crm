(function () {
    ...
    function openCrmPickModal(message, onConfirm) {
        var modalEl = document.getElementById('crmPickModal');
        if (!modalEl || typeof bootstrap === 'undefined') {
        ...
        var messageEl = document.getElementById('crmPickMessage');
        if (messageEl) {
    ...
    function setupCrmDeleteConfirmation() {
        ...
        var pickModalEl = document.getElementById('crmPickModal');
        var pickConfirmBtn = document.getElementById('crmPickConfirmBtn');
        ...
        if (pickConfirmBtn) {
            pickConfirmBtn.addEventListener('click', function () {
                if (crmPickCallback) {
                    crmPickCallback();
        ...
        if (pickModalEl) {
            pickModalEl.addEventListener('hidden.bs.modal', function () {
                crmPickCallback = null;
            });
        }

        document.addEventListener('click', function (event) {
            var pickLink = event.target.closest('a[data-confirm-pick]');
            if (pickLink) {
                event.preventDefault();
                openCrmPickModal(pickLink.getAttribute('data-confirm-pick'), function () {
            ...
            var isPickAction = /pick/i.test(message) || /pick/i.test(legacy.href || '');

            var openModal = isPickAction ? openCrmPickModal : openCrmDeleteModal;
